	        ...
	        <!-- ID perfil -->
	        	<input type="hidden" id="id" name="id" value="">
				  ...
				  <div class="form-group g-mb-20">
				    ...
				    <textarea id="descripcion" name="descripcion" class="form-control form-control-md u-textarea-expandable rounded-0" rows="3" placeholder="Ingrese descripción del perfil"></textarea>
				  </div>
  ...
  $(document).on('ready', function () {
		...
		form_perfiles = $('#form_perfiles').validate({
																rules: {
																	...
																	'fecha_inicio_vigencia': { required: true }
																},
																messages: {
																	'nombre': {
		...
		form_assign_attribute = $('#form_asignar_atributo').validate({
																rules: {
																	...
																	'fecha_inicio_vigencia_atributo_perfil':  { required: true}
																}
						})	
