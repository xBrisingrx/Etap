<section class="container-fluid g-py-10 g-mb-30">
    ...
    <input type="hidden" name="legajo" id="legajo">
	  ...
	  <div class="form-group row g-mb-10">
	    ...
	    <label class="col-form-label g-mb-10" for="fecha_vencimiento">Fecha de vencimiento</label>
	    		    <div class="col-sm-2">
		      <input id="fecha_vencimiento" class="form-control u-form-control rounded-0" type="date" readonly>
		    </div>
	    <a id="pdf_dni" href="#!" target="_blank" class="btn u-btn-primary"> Ver PDF </a>
	  </div>
	  <!-- End Input dni -->
	  ...
	  <div class="form-group row g-mb-10">
	    ...
	    <a id="pdf_cuil" href="#!" target="_blank" class="btn u-btn-primary"> Ver PDF </a>
	  </div>
	  <!-- End Input cuil -->
  ...
  $('#persona_seleccionada').on('change', function(){
    ...
    $.ajax({
      ...
      success: function( response ){
        ...
        $('#fecha_vencimiento').val(response.fecha_vencimiento_dni)
