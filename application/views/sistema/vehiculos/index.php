  ...
  <div class="modal-dialog modal-lg" role="document">
    <div class="modal-content">
      <div class="modal-header">
        ...
        <form id="form_edit_vehiculo" class="form_edit_vehiculo g-brd-around g-brd-gray-light-v4 g-pa-20" method="POST" action="">
...
<script type="text/javascript">
  ...
  document.getElementById('form_edit_vehiculo').addEventListener('submit', function(e){
    e.preventDefault()
  ...
  function agrupar_datos() {
    let data = {
      'id': document.getElementById('vehiculo_id').value,
      'interno': document.getElementById('interno').value,
      'dominio': document.getElementById('dominio').value,
      'anio': document.getElementById('anio').value,
      'patentamiento': document.getElementById('patentamiento').value,
      'marca_id': document.getElementById('marca').value,
      'modelo_id': document.getElementById('modelo').value,
      'tipo_id': document.getElementById('tipo').value,
      'empresa_id': document.getElementById('empresa').value,
